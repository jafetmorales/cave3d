...
final class Noise3D {
	...
	Noise3D(Random random, final int size, final Vector3 waveLength, final double min, final double max, final boolean gaussian) {
		this.size = size;
	...
	Noise3D(Random random, final int size, final double waveLength, final double amplitude, final boolean gaussian) {
		this(random, size, new Vector3(waveLength, waveLength, waveLength), -0.5f * amplitude, 0.5f * amplitude, gaussian);
	}

	Noise3D(Random random, final int size, final double strength, final boolean gaussian) {
